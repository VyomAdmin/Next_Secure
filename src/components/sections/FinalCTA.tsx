            ...
            <div className="container mx-auto px-6">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="flex flex-col items-center gap-12">
                        <Button variant="secondary" href="/about-contact#contact-form" className="py-6 px-16 text-sm font-bold bg-white text-slate-900 border-none rounded-full shadow-2xl hover:bg-[#64ffda] hover:text-black transition-all duration-200 ease-in-out">
                        ...
                        <div className="flex flex-wrap justify-center gap-12 pt-12 border-t border-white/5 w-full">
                            ...
                            <a href="https://wa.me/919953562762" className="flex items-center gap-4 text-slate-400 hover:text-white transition-colors group">
                                ...
                                <span className="font-bold text-sm tracking-widest uppercase">+919953562762</span>
                            </a>
                            <a href="https://wa.me/919953562762" className="flex items-center gap-4 text-slate-400 hover:text-white transition-colors group">
